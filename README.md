...
![APK-Info](https://github.com/Leva0408/APK-Info-SDK-FIX/blob/master/screenshot.png?raw=true "APK-Info")
...
# Download
[Latest releases](https://github.com/Leva0408/APK-Info-SDK-FIX/releases)

[Library of old APK-Info versions](https://mega.nz/#F!DNZxjaAb!2Xx8Y_CO6PYwGDnLRgS5_g)

# How to build the latest version

1. Download [the latest release](https://github.com/Leva0408/APK-Info-SDK-FIX/releases/latest).
2. Download [the source from github](https://github.com/Leva0408/APK-Info-SDK-FIX/archive/master.zip).
